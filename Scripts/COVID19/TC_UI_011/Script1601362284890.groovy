...
WebUI.verifyElementVisible(findTestObject('COVID19 homepage object/div_COVID-19 Panel 4'))

WebUI.verifyElementVisible(findTestObject('COVID19 homepage object/div_COVID-19 Panel 5'))

WebUI.verifyElementVisible(findTestObject('COVID19 homepage object/div_COVID-19 Panel 6'))
